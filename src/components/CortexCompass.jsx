...
export default function CortexCompass(){
  ...
  if(screen==='report')return <CompassReports profile={profile} personContext={personContext} insightAnswers={insightAnswers} answers={answers} demo={demo} onBack={()=>navigate('results')} onEdit={()=>navigate('insights')}/>;
