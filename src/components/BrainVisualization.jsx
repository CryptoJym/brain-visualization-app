...
function BrainVisualization() {
  ...
  return (
    <div className="relative w-full h-screen bg-gradient-to-b from-gray-900 via-purple-900/10 to-black overflow-hidden">
      {/* Header */}
      ...
      <div className="absolute top-24 left-0 bottom-0 w-full max-w-md lg:w-96 p-6 overflow-y-auto">
        <div className="space-y-4">
          ...
          {/* Example Impacts Legend - Below the main card */}
