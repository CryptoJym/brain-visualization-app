...
import BrainVisualizationWrapper from './components/BrainVisualizationWrapper'
...
function App() {
  ...
  if (currentView === 'personalized' && assessmentResults) {
    return (
      <div className="relative">
        <BrainVisualizationWrapper assessmentResults={assessmentResults} />
        <button
  ...
  if (currentView === 'default') {
    ...
    return (
      <div className="relative">
        <BrainVisualizationWrapper brainImpacts={exampleImpacts} />
        <button
          onClick={() => setCurrentView('questionnaire')}
